...
This folder contains cybersecurity portfolio projects and planned writeups.
...
| [AI Security Lab: Entra ID, Least Privilege, and LLM Guardrails](ai-security-entra-llm-lab/README.md) | Completed | Demonstrates managed identity, resource-scoped Azure RBAC, prompt-injection defense, sensitive-data controls, sanitized logging, and automated security tests. |
...
| [Basic IAM Policy Review](basic-iam-policy-review.md) | Planned | Practices least privilege by reviewing and improving example permissions. |
| [Cloud Fundamentals Writeup](cloud-fundamentals-writeup.md) | Planned | Converts cloud fundamentals notes into a project-style security writeup. |
| [SQL / Database Security Project](sql-database-security-project.md) | Planned | Connects SQL coursework to database design, constraints, and sensitive data protection. |
